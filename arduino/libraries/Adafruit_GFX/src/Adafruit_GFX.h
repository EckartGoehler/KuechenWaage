...
public:
  ...
  */
  ...
  virtual void writePixelHLine(int16_t x, int16_t y, uint16_t *colors, uint32_t len);
  virtual void writePixelVLine(int16_t x, int16_t y, uint16_t *colors, uint32_t len);
  ...
  void drawCustomCharTransparent(int16_t x, int16_t y, uint8_t *&bitmap, uint8_t size_x, uint8_t size_y,  uint16_t color, uint8_t h, uint8_t w);
  void drawCustomCharSerial(int16_t x, int16_t y, uint8_t *&bitmap, uint8_t size_x, uint8_t size_y, uint16_t color, uint16 bg, uint8_t h, uint8_t w);
  void drawBuiltInCharTransparent(int16_t x, int16_t y, const uint8_t *font_bitmap, uint8_t size_x, uint8_t size_y, uint16_t color);
  void drawBuiltInCharSerial(int16_t x, int16_t y, const uint8_t *font_bitmap, uint8_t size_x, uint8_t size_y, uint16_t color, uint16_t bg);
